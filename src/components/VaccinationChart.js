...
export default function VaccinationChart({ highlighted }) {
  ...
  const CustomTooltip = ({ active, payload, label }) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-slate-800/95 backdrop-blur-sm p-4 rounded-2xl shadow-2xl border border-white/20">
          <p className="font-bold text-white text-center mb-3 text-lg">{label}</p>
        ...
        <ResponsiveContainer width="100%" height={500}>
          ...
          >
            <defs>
              ...
              <linearGradient id="highlightedGradient" x1="0" y1="0" x2="1" y2="0">
